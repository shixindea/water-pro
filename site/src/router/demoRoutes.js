...
export default [
  ...
  },
  {
    ...
    meta: {"category":"Components","type":"通用","title":"BasicClear","cover":"https://gw.alipayobjects.com/zos/alicdn/GOM1KQ24O/Typography.svg","subtitle":"清除"},
  ...
  },
  {
    ...
    meta: {"category":"Components","type":"通用","title":"BasicClose","cover":"https://gw.alipayobjects.com/zos/alicdn/GOM1KQ24O/Typography.svg","subtitle":"关闭"},
    component: () => import('../../../components/basic-close/demo/index.vue'),
  },
  {
    path: 'basic-arrow:lang(-cn)?',
    meta: {"category":"Components","type":"通用","title":"BasicArrow","subtitle":"三角","cover":"https://gw.alipayobjects.com/zos/alicdn/GOM1KQ24O/Typography.svg"},
    component: () => import('../../../components/basic-arrow/demo/index.vue'),
  },
  {
    path: 'basic-help:lang(-cn)?',
    meta: {"category":"Components","type":"通用","title":"BasicHelp","subtitle":"帮助提示","cover":"https://gw.alipayobjects.com/zos/alicdn/Vyyeu8jq2/Tooltp.svg"},
    component: () => import('../../../components/basic-help/demo/index.vue'),
  },
  {
    path: 'basic-title:lang(-cn)?',
    meta: {"category":"Components","type":"通用","title":"BasicTitle","cover":"https://gw.alipayobjects.com/zos/alicdn/GOM1KQ24O/Typography.svg","subtitle":"独立标题"},
  ...
  },
  {
    ...
    meta: {"category":"Components","type":"数据展示","title":"ColorPicker","cover":"https://gw.alipayobjects.com/zos/alicdn/RT_USzA48/DatePicker.svg","subtitle":"颜色选择器"},
  ...
  },
  {
    ...
    meta: {"category":"Components","type":"通用","title":"ContainerCollapse","cover":"https://gw.alipayobjects.com/zos/alicdn/fNUKzY1sk/Button.svg","subtitle":"展开容器"},
    component: () => import('../../../components/container-collapse/demo/index.vue'),
  },
  {
    path: 'container-list:lang(-cn)?',
    meta: {"category":"Components","type":"通用","title":"ContainerList","cover":"https://gw.alipayobjects.com/zos/alicdn/Vyyeu8jq2/Tooltp.svg","subtitle":"列表容器"},
    component: () => import('../../../components/container-list/demo/index.vue'),
  },
  {
    path: 'container-scroll:lang(-cn)?',
    meta: {"category":"Components","type":"通用","title":"ContainerScroll","cover":"https://gw.alipayobjects.com/zos/alicdn/fNUKzY1sk/Button.svg","subtitle":"滚动容器"},
  ...
  },
  {
    ...
    meta: {"category":"Components","type":"数据录入","cols":1,"title":"FormPro","cover":"https://gw.alipayobjects.com/zos/alicdn/ORmcdeaoO/Form.svg","subtitle":"表单 PRO"},
  ...
  },
  {
    ...
    meta: {"category":"Components","type":"反馈","title":"ModalPro","cover":"https://gw.alipayobjects.com/zos/alicdn/3StSdUlSH/Modal.svg","subtitle":"对话框"},
    component: () => import('../../../components/modal-pro/demo/index.vue'),
  },
  {
    path: 'modal-user:lang(-cn)?',
    meta: {"category":"Components","type":"反馈","title":"ModalUser","cover":"https://gw.alipayobjects.com/zos/alicdn/3StSdUlSH/Modal.svg","subtitle":"用户弹框"},
    component: () => import('../../../components/modal-user/demo/index.vue'),
  },
  {
  ...
  },
  {
    ...
    meta: {"category":"Components","type":"数据展示","title":"PreviewImage","cover":"https://gw.alipayobjects.com/zos/antfincdn/D1dXz9PZqa/image.svg","subtitle":"文字查看图片"},
  ...
  },
  {
    ...
    meta: {"category":"Components","type":"通用","title":"ScrollBar","cover":"https://gw.alipayobjects.com/zos/alicdn/fNUKzY1sk/Button.svg","subtitle":"自定义滚动条"},
  ...
  {
    path: 'select-api:lang(-cn)?',
    meta: {"category":"Components","type":"数据录入","title":"SelectApi","cover":"https://gw.alipayobjects.com/zos/alicdn/_0XzgOis7/Select.svg","subtitle":"选择器 API"},
  ...
  {
    path: 'spin:lang(-cn)?',
    meta: {"category":"Components","type":"通用","title":"Spin","cover":"https://gw.alipayobjects.com/zos/alicdn/8emPa3fjl/Alert.svg","subtitle":"加载中"},
  ...
  },
  {
    ...
    meta: {"category":"Components","cols":1,"type":"数据展示","title":"TablePro","cover":"https://gw.alipayobjects.com/zos/alicdn/f-SbcX2Lx/Table.svg","subtitle":"表格 PRO"},
  ...
  },
  {
    ...
    meta: {"category":"Components","type":"数据录入","title":"TagGroup","cover":"https://gw.alipayobjects.com/zos/alicdn/cH1BOLfxC/Tag.svg","subtitle":"标签组"},
    component: () => import('../../../components/tag-group/demo/index.vue'),
  },
  {
    path: 'tag-modal-list:lang(-cn)?',
    meta: {"category":"Components","type":"数据录入","title":"TagModalList","cover":"https://gw.alipayobjects.com/zos/alicdn/cH1BOLfxC/Tag.svg","subtitle":"标签选择器"},
  ...
  },
  {
    ...
    meta: {"category":"Components","type":"数据录入","title":"UploadCard","cover":"https://gw.alipayobjects.com/zos/alicdn/QaeBt_ZMg/Upload.svg","subtitle":"上传"},
    component: () => import('../../../components/upload-card/demo/index.vue'),
  },
  {
    path: 'upload-image:lang(-cn)?',
    meta: {"category":"Components","type":"数据录入","title":"UploadImage","cover":"https://gw.alipayobjects.com/zos/alicdn/QaeBt_ZMg/Upload.svg","subtitle":"上传图片"},
    component: () => import('../../../components/upload-image/demo/index.vue'),
  },
  {
    path: 'upload-name:lang(-cn)?',
    meta: {"category":"Components","type":"数据录入","title":"UploadName","cover":"https://gw.alipayobjects.com/zos/alicdn/QaeBt_ZMg/Upload.svg","subtitle":"上传名字"},
    component: () => import('../../../components/upload-name/demo/index.vue'),
  },
];