import{d as m,aq as l,J as d,bN as I,bO as o,e as p,H as t,bP as h,G as n,bR as H,k as G,o as sn,E as x,cb as L}from"./vendor.669a7c02.js";import{o as B,f as b,_ as C,p as an,q as on,A as J,r as N}from"./index.dc3dbe16.js";const en=[{title:"name",dataIndex:"name",key:"name"},{title:"Age",dataIndex:"age",key:"age"},{title:"Address",dataIndex:"address",key:"address"},{title:"age-diy",dataIndex:"ageDiy",key:"ageDiy",slots:{customRender:"ageDiy"}}];function cn({params:s,success:c}){const e=[];for(let a=0;a<10;a++)e.push({id:`${a}`,name:`${Math.random()+a}-water`,age:`1${a}`,address:"New York No. 1 Lake ParkNew York No. 1 Lake Park"});setTimeout(()=>{c(e)},1e3)}const pn=m({components:{[B.name]:B},setup(){const[s]=b({api:cn,columns:en,actionColumn:{width:360,title:"\u56FA\u5B9A\u53F3\u8FB9\u7684\u64CD\u4F5C",dataIndex:"action",slots:{customRender:"action"}}});return{actionRegister:s,handleDelete:c=>{console.log(c,"delete")},handleEdit:c=>{console.log(c,"edit")},handleOpen:c=>{console.log(c,"open")}}}}),un=n("pre",{class:"language-vue"},[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
