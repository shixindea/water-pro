import{d as m,aq as l,J as d,bM as C,bN as a,e as p,H as t,bO as h,G as n,bQ as X,k as G,o as sn,E as H,ca as x}from"./vendor.8b615ebb.js";import{o as B,e as w,_ as A,p as an,q as on,A as S,r as J}from"./index.7072b491.js";const en=[{title:"name",dataIndex:"name",key:"name"},{title:"Age",dataIndex:"age",key:"age"},{title:"Address",dataIndex:"address",key:"address"},{title:"age-diy",dataIndex:"ageDiy",key:"ageDiy",slots:{customRender:"ageDiy"}}];function cn({params:s,success:c}){const e=[];for(let o=0;o<10;o++)e.push({id:`${o}`,name:`${Math.random()+o}-water`,age:`1${o}`,address:"New York No. 1 Lake ParkNew York No. 1 Lake Park"});setTimeout(()=>{c(e)},1e3)}const pn=m({components:{[B.name]:B},setup(){const[s]=w({api:cn,columns:en,actionColumn:{width:360,title:"\u56FA\u5B9A\u53F3\u8FB9\u7684\u64CD\u4F5C",dataIndex:"action",slots:{customRender:"action"}}});return{actionRegister:s,handleDelete:c=>{console.log(c,"delete")},handleEdit:c=>{console.log(c,"edit")},handleOpen:c=>{console.log(c,"open")}}}}),un=n("pre",{class:"language-vue"},[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
