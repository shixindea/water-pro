import type { AspectRatio, Coordinates, PositionRestrictions, SizeRestrictions, VisibleArea } from '../typings';
import { approximatedSize } from './approximatedSize';
import { applyMove, diff, fitToLimits, getCenter, intersectionLimits, toLimits } from '../service';
