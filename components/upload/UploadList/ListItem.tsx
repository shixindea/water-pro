...
import IconAntdEye from '@fe6/icon-vue/lib/icons/antd-eye';
  ...
  setup(props, { slots, attrs }) {
    ...
    return () => {
      ...
      const removeIcon = showRemoveIcon
        ? actionIconRender({
            customIcon: customRemoveIcon ? customRemoveIcon({ file }) : <IconBytedDelete />,
      ...
      const downloadIcon =
        showDownloadIcon && file.status === 'done'
          ? actionIconRender({
              customIcon: customDownloadIcon ? customDownloadIcon({ file }) : <IconBytedDownload />,
      ...
      const previewIcon = showPreviewIcon ? (
        ...
        >
          {customPreviewIcon ? customPreviewIcon({ file }) : <IconAntdEye />}
        </a>
      ) : null;
