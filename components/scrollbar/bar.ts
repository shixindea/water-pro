...
import type { Indexable, Nullable } from '../_util/type';

import { defineComponent, h, computed, ref, getCurrentInstance, onUnmounted, inject } from 'vue';
import { defaultConfigProvider } from '../config-provider';
import { addEventListener, removeEventListener } from '../vc-drawer/src/utils';
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const startDrag = (e: any) => {
      ...
      addEventListener(document.body, 'mousemove', mouseMoveDocumentHandler);
      addEventListener(document.body, 'mouseup', mouseUpDocumentHandler);
    ...
    function mouseUpDocumentHandler() {
      ...
      removeEventListener(document.body, 'mousemove', mouseMoveDocumentHandler);
      document.onselectstart = null;
    }

    onUnmounted(() => {
      removeEventListener(document.body, 'mouseup', mouseUpDocumentHandler);
    });
