...
import type { ComponentRef, ElRef, Fn } from '../../../_util/type';
...
export default defineComponent({
  ...
  setup(props: ModalWrapperProps) {
    ...
    onMounted(() => {
      ...
      props.onExtHeight(modalHeaderHeight + modalFooterHeight);
      // listenElResize();
    });
    ...
    async function setModalHeight() {
      ...
      try {
        ...
        props.onHeightChange(unref(realHeightRef));
      } catch (error) {
        warning(error);
      }
    }
