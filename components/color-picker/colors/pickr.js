...
class Pickr {
  ...
  _finalBuild() {
    ...
    if (!opt.useAsButton) {
      ...
      opt.el.parentNode && opt.el.parentNode.replaceChild(root.root, opt.el);
    } else if (opt.inline) {
      opt.el.remove();
    }
  ...
  _bindEvents() {
    ...
    const eventBindings = [
      ...
      _.on(_root.interaction.save, 'click', () => {
        !this.applyColor() && !options.showAlways && this.hide('save');
      }),
    ...
    if (!options.showAlways) {
      ...
      eventBindings.push(
        ...
        _.on(_root.button, 'click', () =>
          this.isOpen() ? this.hide('rootButtonClick') : this.show(),
        ),
        ...
        _.on(
          document,
          'keyup',
          (e) => this.isOpen() && (e.key === ck || e.code === ck) && this.hide('keyup'),
        ),
        ...
        _.on(
          ...
          (e) => {
            if (
              ...
              this.hide(e.eventType ? e.eventType : 'mousedown');
            }
          },
          { capture: true },
        ),
