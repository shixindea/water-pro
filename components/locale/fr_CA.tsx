...
import ColorPicker from '../color-picker/locale/fr_CA';
import FormPro from '../form-pro/locale/fr_CA';
import ModalUser from '../modal-user/locale/fr_CA';
import Classify from '../classify/locale/fr_CA';
