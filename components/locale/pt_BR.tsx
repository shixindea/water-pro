...
import Input from '../input/locale/pt_BR';
import PreviewImage from '../preview-image/locale/pt_BR';
...
import ModalUser from '../modal-user/locale/pt_BR';
import Classify from '../classify/locale/pt_BR';
